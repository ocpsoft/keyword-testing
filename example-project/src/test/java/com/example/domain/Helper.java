...
import java.net.MalformedURLException;public class Helper {

	private static String value;
	private static final int MAX_PAGE_LOAD_TIME_in_seconds = 10;
	private static String rootPath = "D:/DEVELOPMENT/projects/AppUnderTest/src/test/java/com/example/domain/";
	...
	static public URL UpdateTestDomain(DefaultSelenium browser,List<String> inputValues) throws MalformedURLException{String domain=inputValues.get(0);if (domain.startsWith("http")){return new URL(domain);} else if (domain.startsWith("www.")){return new URL("http://" + domain);} else {System.out.println("ERROR: Invalid new domain.  Domain [" + domain+"] can NOT be set as a new Project Context.");return null;}}
	...
	static public void ClickElement(DefaultSelenium browser,List<String> inputValues){browser.click(inputValues.get(0) + "="+inputValues.get(1));if (inputValues.get(2) != null){browser.waitForPageToLoad(Integer.toString(MAX_PAGE_LOAD_TIME_in_seconds * 1000));}}
