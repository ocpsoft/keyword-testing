...
public class Helper {
	...
	private static String rootPath = "D:/_DEVELOPMENT_/projects/AppUnderTest/src/test/java/com/example/domain/";
	...
	static public URL UpdateTestDomain(List<String> inputValues)
		...
		if (domain.startsWith("http")) {
			...
			System.out.println("ERROR: Invalid new domain.  Domain [" + domain
